...
fun AccountScreen(navHostController: NavHostController, viewModel: FinanceManagerViewModel) {
    Scaffold(
        ...
        content = { innerPadding ->
            MainContentAccountScreen(Modifier.padding(innerPadding))
        },
        bottomBar = {
            BottomBarAccountScreen(navHostController)
        }
    )
}

@Composable
fun MainContentAccountScreen(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier
            .fillMaxSize(),
...
@Composable
fun BottomBarAccountScreen(navHostController: NavHostController) {
    BottomAppBar(
        modifier = Modifier,
        actions = {
            Row(
